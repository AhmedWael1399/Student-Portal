    ...
    <div class="center">
        ...
        <form action="view" method="post" onsubmit="return validateForm()">
            ...
            <label class="mt-checkbox">
                <input type="radio" id="teacher" name="radio" value="teacher"> Teachers
            </label>
            <label class="mt-checkbox">
                <input type="radio" id="course" name="radio" value="course"> Courses
            </label>
            <label class="mt-checkbox">
                <input type="radio" id="student" name="radio" value="student"> Students
            </label>
            <br>
            <?php
