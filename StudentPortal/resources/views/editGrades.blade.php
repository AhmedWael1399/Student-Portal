...
<body>
    <div class="center">
        ...
        <form action='editedGrades' method="POST">
            @csrf
            <input class="type-1" type="text" name="cid" placeholder="CID" /><br>
            ...
            <input class="type-1" type="grade" name="grade" placeholder="Grade" /><br>
            <span style="color:red">@error ('grade') {{$message}} @enderror</span><br><br>
            <?php
            ...
            <div class="signup_link">
                <a href="/showTeacherStudents">{{session('username')}}'s Profile</a> <br>
            </div>
        </form>
    </div>
</body>
