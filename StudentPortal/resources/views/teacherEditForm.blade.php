...
<body>
    <div class="center">
        ...
        <form action='teacherEdit' method="POST">
            ...
            <span style="color:red">@error ('tid') {{$message}} @enderror</span><br><br>
            ...
            <input class="type-1" type="password" name="teacher_password" placeholder="Password" /><br>
            <span style="color:red">@error ('teacher_password') {{$message}} @enderror</span><br><br>
